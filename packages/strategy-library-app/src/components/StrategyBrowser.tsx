      ...
      <div className="flex gap-2 border-b border-slate-200">
        <button
          ...
          className={`px-3 py-2 text-sm font-medium ${
            tab === "proactive" ? "border-b-2 border-slate-900 text-slate-900" : "text-slate-500"
          }`}
        >
        ...
        <button
          ...
          className={`px-3 py-2 text-sm font-medium ${
            tab === "responsive" ? "border-b-2 border-slate-900 text-slate-900" : "text-slate-500"
          }`}
        >
...
function StrategyCard({ template, onClick }: { template: StrategyTemplate; onClick: () => void }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="rounded-lg border border-slate-200 bg-white p-4 text-left shadow-sm transition hover:border-slate-300 hover:shadow"
    >
      <div className="flex items-center justify-between gap-2">
        <h3 className="font-medium text-slate-900">{template.techniqueName}</h3>
      ...
      <p className="mt-2 text-sm text-slate-600">{template.evidenceSummary}</p>
